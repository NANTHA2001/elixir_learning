defmodule Phoenixexample.ShoppingCart do
  @moduledoc """
  ...
  alias Phoenixexample.Catalog
  # alias Phoenixexample.ShoppingCart.Cart
  alias Phoenixexample.ShoppingCart.{Cart, CartItem}
  ...
  alias Phoenixexample.ShoppingCart.CartItem

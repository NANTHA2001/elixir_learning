defmodule PhoenixexampleWeb.UrlController do
  use PhoenixexampleWeb, :controller

  alias Phoenixexample.Urls
  alias Phoenixexample.Urls.Url

  action_fallback PhoenixexampleWeb.FallbackController

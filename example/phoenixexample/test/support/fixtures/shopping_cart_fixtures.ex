defmodule Phoenixexample.ShoppingCartFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Phoenixexample.ShoppingCart` context.
  """
  ...
  def cart_fixture(attrs \\ %{}) do
    {:ok, cart} =
      ...
      |> Phoenixexample.ShoppingCart.create_cart()
  ...
  def cart_item_fixture(attrs \\ %{}) do
    {:ok, cart_item} =
      ...
      |> Phoenixexample.ShoppingCart.create_cart_item()

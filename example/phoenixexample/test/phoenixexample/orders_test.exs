defmodule Phoenixexample.OrdersTest do
  use Phoenixexample.DataCase

  alias Phoenixexample.Orders

  describe "orders" do
    alias Phoenixexample.Orders.Order

    import Phoenixexample.OrdersFixtures
  ...
  describe "order_line_items" do
    alias Phoenixexample.Orders.LineItem
